...
export function AdminLoginHero({ className = "" }: { className?: string }) {
  return (
    <main className={`grid min-h-screen place-items-center bg-[radial-gradient(circle_at_16%_12%,rgba(200,178,122,.18),transparent_24rem),radial-gradient(circle_at_84%_0%,rgba(15,95,92,.20),transparent_28rem),linear-gradient(135deg,rgba(248,250,248,.82),rgba(200,178,122,.32))] p-5 text-official ${className}`} dir="rtl">
      <section className="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-security/15 bg-white shadow-[0_24px_70px_rgba(18,48,71,.14)] lg:grid-cols-[1fr_420px]">
