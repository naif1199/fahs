...
export function AdminLoginHero({ className = "" }: { className?: string }) {
  return (
    <main className={`grid min-h-screen place-items-center bg-[radial-gradient(circle_at_16%_12%,rgba(221,161,94,.18),transparent_24rem),radial-gradient(circle_at_84%_0%,rgba(96,108,56,.20),transparent_28rem),linear-gradient(135deg,rgba(254,250,224,.82),rgba(221,161,94,.32))] p-5 text-official ${className}`} dir="rtl">
      <section className="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-security/15 bg-white shadow-[0_24px_70px_rgba(40,54,24,.14)] lg:grid-cols-[1fr_420px]">
