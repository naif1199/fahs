  ...
  if (cinematic) {
    return (
      <form action={action} className="w-full max-w-md space-y-5" dir="rtl">
        ...
        <button className="inline-flex w-full items-center justify-center rounded-full bg-white px-8 py-4 text-lg font-bold text-[#283618] shadow-[0_18px_45px_rgba(0,0,0,.24)] transition-colors hover:bg-[#fefae0] md:py-5 md:text-xl" type="submit">
