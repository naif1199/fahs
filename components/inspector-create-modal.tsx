    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/55 p-4 backdrop-blur-sm">
          <div className="app-card max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-[32px] border border-security/15 bg-[#F8FAF8]/95 p-6 shadow-[0_30px_110px_rgba(18,48,71,.30)]">
